...
# expect_invisible(plot(toyEnrichment, what = "Genome", type = "xSNP"))
# expect_invisible(plot(toyEnrichment, what = "Genome", type = c("eSNP", "xSNP")))
# expect_invisible(plot(toyEnrichment, what = 2, type = c("eSNP", "xSNP")))
# expect_invisible(plot(toyEnrichment, what = 22, type = "eSNP"))
# expect_invisible(plot(toyEnrichment, what = 2, type = c("eSNP", "xSNP"), ggplot = TRUE))
# expect_invisible(plot(toyEnrichment, what = 22, type = "eSNP", ggplot = TRUE))
#
# expect_invisible(data(toyEnrichment))
...
# expect_invisible(excludeFile <- system.file("extdata/Exclude/toyExclude.txt", package = "snpEnrichment"))
# expect_output(toyM1_exclude <- excludeSNP(toyEnrichment, excludeFile, mc.cores = 1))
# expect_type(print(toyM1_exclude, what = "All"))
...
# expect_output(res_toyM1 <- compareEnrichment(object.x = toyEnrichment, object.y = toyM1_exclude, pattern = "Chrom", nSample = 10, empiricPvalue = FALSE, mc.cores = 1, onlyGenome = FALSE))
# expect_invisible(data(toyEnrichment))
# expect_output(reSample(object = toyEnrichment, nSample = 10, empiricPvalue = FALSE, MAFpool = c(0.05, 0.10, 0.2, 0.3, 0.4, 0.5), mc.cores = 1, onlyGenome = FALSE))
# expect_invisible(excludeFile <- system.file("extdata/Exclude/toyExclude.txt", package = "snpEnrichment"))
# expect_output(toyM1_exclude <- excludeSNP(toyEnrichment, excludeFile, mc.cores = 1))
...
# expect_output(res_toyM1 <- compareEnrichment(object.x = toyEnrichment, object.y = toyM1_exclude, pattern = "Chrom", nSample = 10, empiricPvalue = FALSE, mc.cores = 2, onlyGenome = FALSE))
#
# expect_invisible(data(toyEnrichment))
# expect_s3_class(trash <- getEnrichSNP(toyEnrichment, type = "eSNP"), "data.frame")
# expect_s3_class(trash <- getEnrichSNP(toyEnrichment, type = "xSNP"), "data.frame")
