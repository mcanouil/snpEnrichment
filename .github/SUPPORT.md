# Getting help with snpEnrichment

Thanks for using snpEnrichment. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/snpEnrichment/issues) to make sure the 
